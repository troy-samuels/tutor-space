-- Migration: Extend get_dashboard_summary RPC with meeting links
...
'Returns consolidated dashboard summary data for a tutor including profile, upcoming bookings (with meeting links), counts, and revenue. SECURITY: Validates that auth.uid() matches p_tutor_id to prevent unauthorized access.';
