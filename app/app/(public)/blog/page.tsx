...
export const metadata: Metadata = {
  title: "Blog | TutorLingua - Resources for Independent Language Tutors",
  description:
    "Expert guides and strategies for independent language tutors. Learn how to reduce platform fees, get more students, and build a sustainable tutoring business.",
  keywords: [
    "tutoring tips",
    "language tutor blog",
    "reduce Preply commission",
    "tutoring business guide",
    "iTalki tips for tutors",
    "online tutoring strategies",
  ],
  openGraph: {
    title: "TutorLingua Blog - Resources for Language Tutors",
    description:
      "Expert guides for independent language tutors. Reduce fees, get students, grow your business.",
    type: "website",
    url: "https://tutorlingua.com/blog",
  },
  alternates: {
    languages: {
      en: "/blog",
...
export default function BlogIndexPage() {
  ...
  const blogSchema = generateBlogSchema(baseUrl, "en");
  const itemListSchema = generateBlogItemListSchema(posts, baseUrl, "en");
  const breadcrumbSchema = generateBlogIndexBreadcrumbSchema(baseUrl, "en");
  const organizationSchema = generateOrganizationSchema(baseUrl);
  const webSiteSchema = generateWebSiteSchema(baseUrl, "en");
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Expert guides, strategies, and tips for independent language
              tutors. Learn how to grow your business, reduce fees, and keep
              more of your income.
            </p>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Hand-picked guides to help you succeed
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our content organized by the topics that matter most to independent tutors
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <TopicCard
              title="Reducing Fees"
              description="Learn how to keep more of your tutoring income by understanding platform commissions."
            ...
            <TopicCard
              title="Tools & Tech"
              description="The essential software and systems for running a professional tutoring business."
            ...
            />
            <TopicCard
              title="Getting Students"
              description="Marketing strategies and tips for attracting more students to your tutoring business."
            ...
            <TopicCard
              ...
              description="Best practices for retaining students and building long-term relationships."
              href="/blog?category=students"
              count={6}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
