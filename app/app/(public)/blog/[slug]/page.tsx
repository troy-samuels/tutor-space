...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: "Post Not Found | TutorLingua Blog",
    };
  }
  ...
  return {
    ...
    alternates: {
      ...
      languages: post.alternateLocale
        ? {
            [post.alternateLocale.locale]: `${baseUrl}/${post.alternateLocale.locale}/blog/${post.alternateLocale.slug}`,
          }
        : undefined,
    },
    robots: {
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          {post.alternateLocale && (
            <div className="mt-6 pt-6 border-t border-white/10">
              <Link
                href={`/${post.alternateLocale.locale}/blog/${post.alternateLocale.slug}`}
      ...
      <article className="relative">
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <footer className="mt-16 pt-8 border-t border-gray-200">
            {/* Tags */}
            <div className="mb-8">
              <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">Topics</h4>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href={`mailto:?subject=${encodeURIComponent(post.title)}&body=${encodeURIComponent(`Check out this article: ${baseUrl}/blog/${post.slug}`)}`}
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(`${baseUrl}/blog/${post.slug}`);
                  }}
