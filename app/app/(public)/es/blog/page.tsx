...
export const metadata: Metadata = {
  title: "Blog | TutorLingua - Recursos para Tutores de Idiomas Independientes",
  description:
    "Guías expertas y estrategias para tutores de idiomas independientes. Aprende cómo reducir comisiones de plataformas, conseguir más estudiantes y construir un negocio de tutoría sostenible.",
  keywords: [
    "consejos de tutoría",
    "blog para tutores de idiomas",
    "reducir comisión Preply",
    "guía negocio tutoría",
    "consejos iTalki para tutores",
    "estrategias tutoría online",
  ],
  openGraph: {
    title: "Blog de TutorLingua - Recursos para Tutores de Idiomas",
    description:
...
function BlogCard({ post, featured = false }: { post: BlogPostMeta; featured?: boolean }) {
  return (
    ...
    >
      <Link href={`/es/blog/${post.slug}`} className="block h-full">
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      {categories.map((category) => (
        <Link
          key={category}
          href={`/es/blog?category=${encodeURIComponent(category.toLowerCase())}`}
          className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
...
export default function BlogIndexPageES() {
  ...
  const itemListSchema = generateBlogItemListSchema(posts, baseUrl, "es");
  const breadcrumbSchema = generateBlogIndexBreadcrumbSchema(baseUrl, "es");
  const organizationSchema = generateOrganizationSchema(baseUrl);
  const webSiteSchema = generateWebSiteSchema(baseUrl, "es");
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm shadow-sm border border-gray-200/50 text-sm font-medium text-gray-700 mb-6">
              ...
              Actualizado semanalmente con contenido fresco
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Guías expertas, estrategias y consejos para tutores de idiomas
              independientes. Aprende cómo hacer crecer tu negocio, reducir
              comisiones y conservar más de tus ingresos.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">Escrito por expertos en tutoría</span>
              </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Guías seleccionadas para ayudarte a tener éxito
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Explora nuestra biblioteca completa de recursos
              </p>
            </div>
            {/* Category Filter */}
          ...
          {posts.length === 0 && (
            <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
              ...
              <p className="text-lg font-medium text-gray-900">No se encontraron artículos</p>
              <p className="text-gray-500 mt-1">¡Vuelve pronto para nuevo contenido!</p>
            </div>
          )}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explora nuestro contenido organizado por los temas más importantes para tutores independientes
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <TopicCard
              title="Reducir Comisiones"
              description="Aprende cómo conservar más de tus ingresos de tutoría entendiendo las comisiones de plataformas."
              href="/es/blog?category=negocio"
              count={8}
              icon={
            ...
            <TopicCard
              ...
              description="El software y sistemas esenciales para administrar un negocio de tutoría profesional."
              href="/es/blog?category=herramientas"
              count={8}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <TopicCard
              ...
              description="Estrategias de marketing y consejos para atraer más estudiantes a tu negocio de tutoría."
              href="/es/blog?category=marketing"
              count={8}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <TopicCard
              ...
              description="Mejores prácticas para retener estudiantes y construir relaciones a largo plazo."
              href="/es/blog?category=estudiantes"
              count={6}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
            ...
            <div className="relative">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
                Recibe Consejos de Tutoría en Tu Correo
              </h2>
              <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
                Únete a miles de tutores de idiomas que reciben nuestro boletín
                semanal con estrategias prácticas para hacer crecer su negocio.
              </p>
