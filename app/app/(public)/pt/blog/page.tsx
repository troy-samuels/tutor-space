...
export const metadata: Metadata = {
  title: "Blog | TutorLingua - Recursos para Tutores de Idiomas Independentes",
  description:
    "Guias especializados e estratégias para tutores de idiomas independentes. Aprenda a reduzir comissões de plataformas, conseguir mais alunos e construir um negócio de tutoria sustentável.",
  keywords: [
    "dicas de tutoria",
    "blog para tutores de idiomas",
    "reduzir comissão Preply",
    "guia negócio de tutoria",
    "dicas iTalki para tutores",
    "estratégias de tutoria online",
  ],
  openGraph: {
    title: "Blog TutorLingua - Recursos para Tutores de Idiomas",
    description:
      "Guias especializados para tutores de idiomas independentes. Reduza comissões, conquiste alunos, expanda seu negócio.",
    type: "website",
    url: "https://tutorlingua.com/pt/blog",
  },
  alternates: {
    languages: {
      en: "/blog",
...
function BlogCard({ post, featured = false }: { post: BlogPostMeta; featured?: boolean }) {
  return (
    ...
    >
      <Link href={`/pt/blog/${post.slug}`} className="block h-full">
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      {categories.map((category) => (
        <Link
          key={category}
          href={`/pt/blog?category=${encodeURIComponent(category.toLowerCase())}`}
          className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
...
export default function BlogIndexPagePT() {
  const posts = getAllBlogPosts("pt");
  const categories = getAllCategories("pt");
  const featuredPosts = posts.filter((post) => post.featured).slice(0, 3);
  const recentPosts = posts.slice(0, 12);

  const baseUrl = "https://tutorlingua.com";

  const blogSchema = generateBlogSchema(baseUrl, "pt");
  const itemListSchema = generateBlogItemListSchema(posts, baseUrl, "pt");
  const breadcrumbSchema = generateBlogIndexBreadcrumbSchema(baseUrl, "pt");
  const organizationSchema = generateOrganizationSchema(baseUrl);
  const webSiteSchema = generateWebSiteSchema(baseUrl, "pt");
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm shadow-sm border border-gray-200/50 text-sm font-medium text-gray-700 mb-6">
              ...
              Atualizado semanalmente com conteúdo novo
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Guias especializados, estratégias e dicas para tutores de idiomas
              independentes. Aprenda a expandir seu negócio, reduzir
              comissões e manter mais da sua renda.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">Escrito por especialistas em tutoria</span>
              </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Guias selecionados para ajudá-lo a ter sucesso
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Explore nossa biblioteca completa de recursos
              </p>
            </div>
          ...
          {posts.length === 0 && (
            <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
              ...
              <p className="text-lg font-medium text-gray-900">Nenhum artigo encontrado</p>
              <p className="text-gray-500 mt-1">Volte em breve para novos conteúdos!</p>
            </div>
          )}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore nosso conteúdo organizado pelos temas mais importantes para tutores independentes
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <TopicCard
              title="Reduzir Comissões"
              description="Aprenda a manter mais da sua renda de tutoria entendendo as comissões das plataformas."
              href="/pt/blog?category=business"
              count={4}
              icon={
            ...
            <TopicCard
              ...
              description="Softwares e sistemas essenciais para gerenciar um negócio de tutoria profissional."
              href="/pt/blog?category=ferramentas"
              count={4}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            />
            <TopicCard
              title="Encontrar Alunos"
              description="Estratégias de marketing e dicas para atrair mais alunos para o seu negócio de tutoria."
              href="/pt/blog?category=marketing"
              count={3}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <TopicCard
              ...
              description="Melhores práticas para reter alunos e construir relacionamentos de longo prazo."
              href="/pt/blog?category=retencao"
              count={4}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
            ...
            <div className="relative">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
                Receba Dicas de Tutoria por Email
              </h2>
              <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
                Junte-se a milhares de tutores de idiomas que recebem nossa newsletter
                semanal com estratégias práticas para expandir seu negócio.
              </p>
              ...
              <p className="mt-4 text-sm text-blue-200">
                Sem spam, cancele quando quiser. Respeitamos sua privacidade.
              </p>
            </div>
          </div>
        </div>
