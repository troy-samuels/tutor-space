...
export const metadata: Metadata = {
  title: "Blog | TutorLingua - Ressourcen für Selbstständige Sprachlehrer",
  description:
    "Expertenanleitungen und Strategien für selbstständige Sprachlehrer. Lernen Sie, Plattformprovisionen zu reduzieren, mehr Schüler zu gewinnen und ein nachhaltiges Nachhilfegeschäft aufzubauen.",
  keywords: [
    "Nachhilfe-Tipps",
    "Blog für Sprachlehrer",
    "Preply-Provision reduzieren",
    "Nachhilfegeschäft-Leitfaden",
    "iTalki-Tipps für Tutoren",
    "Online-Nachhilfe-Strategien",
  ],
  openGraph: {
    title: "TutorLingua Blog - Ressourcen für Sprachlehrer",
    description:
      "Expertenanleitungen für selbstständige Sprachlehrer. Provisionen reduzieren, Schüler gewinnen, Geschäft ausbauen.",
    type: "website",
    url: "https://tutorlingua.com/de/blog",
  },
  alternates: {
    languages: {
      en: "/blog",
...
function BlogCard({ post, featured = false }: { post: BlogPostMeta; featured?: boolean }) {
  return (
    ...
    >
      <Link href={`/de/blog/${post.slug}`} className="block h-full">
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      {categories.map((category) => (
        <Link
          key={category}
          href={`/de/blog?category=${encodeURIComponent(category.toLowerCase())}`}
          className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
...
export default function BlogIndexPageDE() {
  const posts = getAllBlogPosts("de");
  ...
  const blogSchema = generateBlogSchema(baseUrl, "de");
  const itemListSchema = generateBlogItemListSchema(posts, baseUrl, "de");
  const breadcrumbSchema = generateBlogIndexBreadcrumbSchema(baseUrl, "de");
  const organizationSchema = generateOrganizationSchema(baseUrl);
  const webSiteSchema = generateWebSiteSchema(baseUrl, "de");
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm shadow-sm border border-gray-200/50 text-sm font-medium text-gray-700 mb-6">
              ...
              Wöchentlich mit neuen Inhalten aktualisiert
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Expertenanleitungen, Strategien und Tipps für selbstständige Sprachlehrer.
              Lernen Sie, Ihr Geschäft auszubauen, Provisionen zu reduzieren
              und mehr von Ihrem Einkommen zu behalten.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">Von Nachhilfe-Experten geschrieben</span>
              </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Ausgewählte Anleitungen für Ihren Erfolg
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Entdecken Sie unsere vollständige Ressourcenbibliothek
              </p>
            </div>
          ...
          {posts.length === 0 && (
            <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
              ...
              <p className="text-lg font-medium text-gray-900">Keine Artikel gefunden</p>
              <p className="text-gray-500 mt-1">Schauen Sie bald wieder vorbei für neue Inhalte!</p>
            </div>
          )}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Entdecken Sie unsere Inhalte, organisiert nach den wichtigsten Themen für selbstständige Tutoren
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <TopicCard
              title="Provisionen Reduzieren"
              description="Lernen Sie, mehr von Ihren Nachhilfe-Einnahmen zu behalten, indem Sie Plattformprovisionen verstehen."
              href="/de/blog?category=business"
              count={4}
              icon={
            ...
            />
            <TopicCard
              title="Tools und Technologie"
              description="Essentielle Software und Systeme für ein professionelles Nachhilfegeschäft."
              href="/de/blog?category=tools"
              count={4}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            />
            <TopicCard
              title="Schüler Finden"
              description="Marketing-Strategien und Tipps, um mehr Schüler für Ihr Nachhilfegeschäft zu gewinnen."
              href="/de/blog?category=marketing"
              count={3}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <TopicCard
              ...
              description="Best Practices für die Schülerbindung und den Aufbau langfristiger Beziehungen."
              href="/de/blog?category=retention"
              count={4}
              icon={
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
            ...
            <div className="relative">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
                Nachhilfe-Tipps per E-Mail Erhalten
              </h2>
              <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
                Schließen Sie sich Tausenden von Sprachlehrern an, die unseren wöchentlichen
                Newsletter mit praktischen Strategien zum Geschäftsausbau erhalten.
              </p>
