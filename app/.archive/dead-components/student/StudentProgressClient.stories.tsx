    ...
    recentNotes: [
      {
        ...
        vocabulary_words: ["ojalá", "esperar que", "recomendar que", "es importante que", "quisiera"],
        homework: null,
        student_performance: "Natural conversational flow, good progress with irregular forms",
        areas_to_focus: ["More practice with emotional expressions"],
        notes: "Excellent progress on the subjunctive! You're starting to use it naturally in conversation. Keep practicing the irregular forms.",
