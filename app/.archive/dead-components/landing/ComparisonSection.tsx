  ...
  return (
    <section className="bg-muted py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block mx-auto mt-16 overflow-hidden rounded-3xl bg-background shadow-lg">
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-primary/5">
                ...
                <th className="py-5 px-6 text-center text-base font-semibold text-muted-foreground">
                  {headers.marketplace}
                </th>
            ...
            <tbody className="divide-y divide-gray-200">
              {comparison.columns.slice(1).map((row, index) => (
                <tr key={index} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="py-5 px-6 text-center text-sm text-muted-foreground">
                    {row.marketplace}
                  </td>
        ...
        {/* Caption */}
        <p className="mt-6 sm:mt-8 text-center text-xs sm:text-sm text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          {comparison.caption}
        </p>
      </div>
    </section>
