...
/**
 * Helper: Require authenticated student
 */
async function requireStudent() {
  ...
  return { supabase, userId: user.id, student };
}
...
export function getEventTypeColor(eventType: TimelineEventType): string {
  const colorMap: Record<TimelineEventType, string> = {
    ...
    onboarding_started: "text-purple-500",
    onboarding_completed: "text-green-500",
    onboarding_item_completed: "text-green-400",
    booking_created: "text-blue-500",
    booking_completed: "text-green-500",
    booking_cancelled: "text-red-500",
    booking_rescheduled: "text-yellow-500",
    message_sent: "text-blue-400",
    message_received: "text-blue-400",
    homework_assigned: "text-orange-500",
    homework_completed: "text-green-500",
    homework_submitted: "text-blue-500",
    practice_session_completed: "text-purple-500",
    drill_completed: "text-purple-400",
    goal_created: "text-blue-500",
    goal_completed: "text-green-500",
    assessment_recorded: "text-blue-500",
    payment_received: "text-green-500",
    package_purchased: "text-green-500",
    subscription_started: "text-blue-500",
    status_changed: "text-gray-500",
    risk_status_changed: "text-orange-500",
    note_added: "text-yellow-500",
    label_added: "text-blue-400",
    label_removed: "text-gray-400",
    first_lesson: "text-yellow-500",
    lesson_milestone: "text-yellow-500",
  };

  return colorMap[eventType] ?? "text-gray-500";
}
