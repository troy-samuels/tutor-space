...
export const mockChatWithPronunciation: ChatMessage[] = [
  ...mockChatMessages.slice(0, 4),
  {
    ...
    pronunciation: {
      accuracy: 85,
      feedback: "Good pronunciation! The 'rr' in 'cerca' was a bit soft - try to roll it more. The 'v' in 'ventana' should sound like a soft 'b'.",
    },
...
export const mockLessonNotes: LessonNote[] = [
  {
    ...
    vocabulary: ["menú", "pedir", "la cuenta", "de primero", "de segundo"],
    grammar_points: ["Me gustaría + infinitive", "Conditional for politeness"],
    student_feedback: "Great progress on restaurant vocabulary! You're getting more confident with ordering. Next time, let's practice handling unexpected situations like dietary restrictions or complaints.",
    next_lesson_focus: "Practice handling special requests and complaints in a restaurant setting",
  ...
  },
  {
    ...
    vocabulary: ["fue", "hizo", "dijo", "vino", "puso"],
    grammar_points: ["Preterite vs Imperfect", "Irregular preterite verbs"],
    student_feedback: "You're doing well with regular past tense verbs. The irregular ones need more practice - try writing a short diary entry each day using past tense.",
    next_lesson_focus: "Continue with irregular preterite, introduce imperfect tense",
  ...
  },
  {
    ...
    vocabulary: ["ojalá", "esperar que", "recomendar que", "es importante que"],
    grammar_points: ["Subjunctive triggers", "Present subjunctive conjugation"],
    student_feedback: "The subjunctive is challenging, but you're making good progress. Remember: 'ojalá' always triggers subjunctive. Keep practicing the conjugation patterns.",
    next_lesson_focus: "More subjunctive practice with different triggers",
