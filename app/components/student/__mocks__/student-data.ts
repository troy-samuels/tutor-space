...
export const mockLessonNotes: LessonNote[] = [
  {
    ...
    vocabulary_words: ["menú", "pedir", "la cuenta", "de primero", "de segundo"],
    homework: null,
    student_performance: "Natural conversational flow when ordering",
    areas_to_focus: ["Handle unexpected situations like dietary restrictions"],
    notes: "Great progress on restaurant vocabulary! You're getting more confident with ordering. Next time, let's practice handling unexpected situations like dietary restrictions or complaints.",
  ...
  },
  {
    ...
    vocabulary_words: ["fue", "hizo", "dijo", "vino", "puso"],
    homework: "Write a short diary entry each day using past tense",
    student_performance: "Good with regular past tense verbs",
    areas_to_focus: ["Irregular preterite verbs"],
    notes: "You're doing well with regular past tense verbs. The irregular ones need more practice - try writing a short diary entry each day using past tense.",
  ...
  },
  {
    ...
    vocabulary_words: ["ojalá", "esperar que", "recomendar que", "es importante que"],
    homework: null,
    student_performance: "Good understanding of subjunctive triggers",
    areas_to_focus: ["Subjunctive conjugation patterns"],
    notes: "The subjunctive is challenging, but you're making good progress. Remember: 'ojalá' always triggers subjunctive. Keep practicing the conjugation patterns.",
