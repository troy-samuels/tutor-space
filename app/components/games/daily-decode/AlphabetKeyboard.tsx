                ...
                {row.map((letter) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="flex min-h-[44px] min-w-[2.75rem] items-center justify-center rounded-lg text-sm font-semibold transition-colors touch-manipulation select-none cursor-pointer"
                      style={
                        isCorrect
                          ? {
