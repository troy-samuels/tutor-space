...
const GAMES: GameDef[] = [
  ...
  { slug: "connections", name: "Connections", description: "Group four words that share a hidden link", colour: "#D4A843", colourLight: "rgba(212,168,67,0.08)", live: false },
  { slug: "daily-decode", name: "Daily Decode", description: "Crack the cipher to reveal a quote", colour: "#D36135", colourLight: "rgba(211,97,53,0.08)", live: false },
  { slug: "word-ladder", name: "Word Ladder", description: "Change one letter at a time to reach the target", colour: "#3E5641", colourLight: "rgba(62,86,65,0.08)", live: false },
  { slug: "synonym-spiral", name: "Synonym Spiral", description: "Climb the tower by finding synonyms", colour: "#8B5CB5", colourLight: "rgba(139,92,181,0.08)", live: false },
  { slug: "missing-piece", name: "Missing Piece", description: "Fill the gap in the sentence", colour: "#5A8AB5", colourLight: "rgba(90,138,181,0.08)", live: false },
  { slug: "odd-one-out", name: "Odd One Out", description: "Find the word that doesn't belong", colour: "#D36135", colourLight: "rgba(211,97,53,0.08)", live: false },
  { slug: "neon-intercept", name: "Neon Intercept", description: "Intercept translations in neon lanes", colour: "#D36135", colourLight: "rgba(211,97,53,0.08)", live: false },
