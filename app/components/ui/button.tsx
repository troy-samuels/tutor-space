 ...
 */
type ButtonVariant = "default" | "secondary" | "outline" | "ghost" | "link" | "destructive" | "immersive";
...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  immersive:
    "bg-primary text-white hover:bg-primary/90 shadow-[0_4px_24px_-4px_rgba(232,120,77,0.6)] focus-visible:ring-primary",
};
