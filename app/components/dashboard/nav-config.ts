import { CalendarDays, Users, Lightbulb, MessageCircle, Bot, Store, Video, LucideIcon } from "lucide-react";
...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/classroom/test", label: "Video Studio", icon: Video, description: "Native HD video classroom with recording and transcription.", studioFeature: true },
