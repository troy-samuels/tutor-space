...
- Automated booking system ([TutorLingua handles booking + payments](/features/booking))
...
See our complete guide on [how much to charge for private lessons](/blog/en/cluster-3-business/how-much-charge-private-lessons) for advanced pricing strategies.
...
1. Monthly subscription (RECOMMENDED)
2. 10-lesson package
3. 5-lesson package
4. Single trial session
...
When you have a waitlist, demand exceeds supply—that justifies premium pricing. See our guide on [building a waitlist when fully booked](/blog/en/cluster-3-business/tutor-waitlist-fully-booked).
...
Read about [hidden business expenses](/blog/en/cluster-3-business/tutoring-business-expenses) to budget properly for tools and services.
...
**Week 2:**
- [ ] Implement automated booking system ([TutorLingua free plan](/features/booking))
...
**Ready to scale?** [TutorLingua provides the professional booking, payment, and student management tools you need to grow efficiently](/signup). Free to start, built for scaling.

---

*Related reading:*
- [Should You Quit Your Job to Tutor Full-Time? A Financial Breakdown](/blog/en/cluster-3-business/quit-job-tutor-full-time)
- [Creating Session Packages That Students Actually Buy](/blog/en/cluster-3-business/session-packages-students-buy)
- [Building a Waitlist: What to Do When You're Fully Booked](/blog/en/cluster-3-business/tutor-waitlist-fully-booked)
