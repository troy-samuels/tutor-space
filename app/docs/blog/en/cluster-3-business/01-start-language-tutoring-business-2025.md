...
|-----------|----------|------|------|
| **Sole Proprietorship** | Part-time tutors testing the waters | Simple, low cost, easy taxes | No liability protection |
| **LLC** | Serious business builders | Liability protection, professional image | More paperwork, annual fees |
| **S-Corp** | High earners ($60k+ profit) | Tax savings on self-employment tax | Complex accounting, payroll requirements |
...
This is why experienced tutors charge $40-80/hour—they understand their [true hourly rate after all expenses](/blog/en/cluster-1-platform-costs/true-hourly-rate-after-fees).
...
See our complete guide on [how much to charge for private language lessons](/blog/en/cluster-3-business/how-much-charge-private-lessons) for detailed pricing frameworks.
...
- [TutorLingua](/features/booking) (from $0/month) - built specifically for language tutors, combines booking, payments, and student management
...
**Total monthly cost**: $15-50 for a professional setup. See our [complete tutor tech stack guide](/blog/en/cluster-2-tools/tutor-tech-stack-2025) for detailed tool comparisons.
...
- Tools like [TutorLingua](/features/booking) provide a professional booking page with your photo, bio, services, and calendar
...
Read our detailed guide on [creating session packages that students actually buy](/blog/en/cluster-3-business/session-packages-students-buy) for pricing psychology and package design.
...
- Join Preply/italki for 3 months maximum
- Use it purely for student acquisition
- After 5-10 lessons, [convert interested students to direct booking](/blog/en/cluster-1-platform-costs/convert-students-direct-booking)
- Stop accepting new platform students once you hit 10 direct clients

**Target**: 5-10 students transitioned to direct booking

See our complete playbook: [How to get your first 10 students as a new online tutor](/blog/en/cluster-3-business/first-10-students-new-tutor).
...
- Integrates with booking systems like [TutorLingua](/features/payments)
- Pays out in 2 days
...
See our guide on [tutoring business expenses nobody talks about](/blog/en/cluster-3-business/tutoring-business-expenses) for complete financial planning.
...
- Build a [waitlist system](/blog/en/cluster-3-business/tutor-waitlist-fully-booked)
- Add group classes (1 hour teaching = 5-8 students paying)
- Create self-study digital products
- Consider [transitioning from side hustle to full-time](/blog/en/cluster-3-business/side-hustle-full-time-tutoring)

## Common Mistakes New Tutors Make

**Pricing too low out of fear**
Starting at $15/hour seems safe but teaches students to expect cheap service and makes scaling impossible. Start at $25-30 minimum.

**No clear booking process**
"DM me to schedule" creates friction. Every extra step loses 20-30% of potential bookings. Use a proper [booking system](/features/booking).

**Trying to serve everyone**
"I teach all levels, all ages, all goals" dilutes your marketing and attracts price-shoppers. Niche down.

**Not collecting testimonials**
Ask every satisfied student for a short testimonial. Future students trust peer reviews more than your credentials.

**Inconsistent marketing**
Posting for 2 weeks, getting discouraged, stopping. Marketing is a consistent habit, not a campaign.

**No systems for admin work**
Manually scheduling every lesson, sending payment reminders, tracking student progress. These tasks compound and burn you out. Automate early.
...
**Your second action step**: Set up a professional booking system. [TutorLingua](/signup) offers everything you need—scheduling, payments, student management—specifically designed for language tutors. Get started free and upgrade only when you're earning.
...
*Related reading:*
- [How Much Should I Charge for Private Language Lessons?](/blog/en/cluster-3-business/how-much-charge-private-lessons)
- [How to Get Your First 10 Students as a New Online Tutor](/blog/en/cluster-3-business/first-10-students-new-tutor)
- [Should You Quit Your Job to Tutor Full-Time?](/blog/en/cluster-3-business/quit-job-tutor-full-time)
