...
- **Platform/booking fees**: 0-3% ([TutorLingua](/features/booking) vs. payment processor fees)
...
This is why tutors who understand their numbers charge $40-80/hour while beginners stuck at $20/hour struggle to survive. For a deeper breakdown, read our guide on [calculating your true hourly rate after fees and expenses](/blog/en/cluster-1-platform-costs/true-hourly-rate-after-fees).
...
| Tutor | Rate | Experience | Credentials | Specialty |
|-------|------|------------|-------------|-----------|
| Example 1 | $35/hr | 3 years | DELE certified | Business Spanish |
| Example 2 | $50/hr | 7 years | MA Applied Linguistics | Exam prep |
| Example 3 | $25/hr | 1 year | Native speaker | Conversation |
...
**Strategy**: Premium positioning. Focus marketing on transformation and exclusivity rather than accessibility. Consider [building a waitlist](/blog/en/cluster-3-business/tutor-waitlist-fully-booked) to create demand.
...
See our complete guide: [Creating session packages that students actually buy](/blog/en/cluster-3-business/session-packages-students-buy).
...
Being the cheapest attracts price-sensitive students who'll leave for anyone $2 cheaper. Compete on value instead.

**Mistake 2: Not accounting for unpaid time**
Setting rates based only on teaching time, not prep and admin. Leads to burnout when you realize you're working for $12/hour.

**Mistake 3: Never raising rates**
Tutors who taught for 5 years at the same rate they charged on day one. Your skills improve—your rates should too.

**Mistake 4: Apologizing for your rates**
"I know it's expensive, but..." signals lack of confidence. State your rates matter-of-factly.

**Mistake 5: Offering too many discounts**
"Family discount, friend discount, first-time discount, financial hardship discount..." Devalues your work and creates expectation of flexibility.
...
- Efficient booking and payment systems ([TutorLingua](/features/booking) handles both)
- Clear student acquisition strategy ([getting your first 10 students](/blog/en/cluster-3-business/first-10-students-new-tutor))
...
*Related reading:*
- [How to Start a Private Language Tutoring Business: The 2025 Guide](/blog/en/cluster-3-business/start-language-tutoring-business-2025)
- [From Side Hustle to Full-Time: Scaling Your Tutoring Income](/blog/en/cluster-3-business/side-hustle-full-time-tutoring)
- [The True Hourly Rate After Platform Fees](/blog/en/cluster-1-platform-costs/true-hourly-rate-after-fees)
