...
import {
  generateConnectionsShareCard,
  generateSpellCastShareCard,
  generateSpeedClashShareCard,
  generateWordRunnerShareCard,
  generateVocabClashShareCard,
} from '../src/utils/share-cards.js';
...
describe('generateConnectionsShareCard', () => {
  it('should generate share card for completed puzzle', () => {
    const result = {
      ...
      timeSeconds: 154,
      streak: 12,
      groups: ['yellow' as const, 'green' as const, 'blue' as const, 'purple' as const],
    };
  ...
  it('should handle failed puzzle', () => {
    const result = {
      ...
      completed: false,
      timeSeconds: 200,
      groups: ['yellow' as const, 'green' as const],
    };
